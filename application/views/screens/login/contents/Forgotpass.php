<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <form method="POST" action="<?= base_url('auth/forgotpassword'); ?>" class="login100-form validate-form">
                <span class="login100-form-title">Lupa password?</span>
                ...
                <div class="container-login100-form-btn">
                    <button type="submit" class="login100-form-btn">Lupa password</button>
                </div>
